...
export default function PricingCards({
   ...
   cta,
   isPopular,
   i // 👈 add i when mapping this component
}) {
   const [expanded, setExpanded] = useState(false);

   // Define how many features to show by default per i
   const defaultVisible = [7, 5, 3][i] || 3;
   const visibleFeatures = expanded
      ? features
      : features.slice(0, defaultVisible);

   return (
      <div className="mx-auto w-full sm:w-72 md:w-80 lg:w-96">
         <div
         ...
         >
            ...
            >
               {features.length > defaultVisible && (
                  <button
